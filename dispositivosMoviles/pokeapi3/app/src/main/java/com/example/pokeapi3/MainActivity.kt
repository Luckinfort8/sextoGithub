...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val retrofit = Retrofit.Builder()
            .baseUrl("http://192.168.23.139:8080/api/v1/")
    ...
    private fun loadPokemonList() {
        val call = apiService.getPokemonList() // Debes definir este método en tu servicio
        ...
        call.enqueue(object : Callback<List<Pokemon>> {
            override fun onResponse(call: Call<List<Pokemon>>, response: Response<List<Pokemon>>) {
                if (response.isSuccessful) {
                    ...
                    Toast.makeText(this@MainActivity, "Error al obtener la lista de Pokémon", Toast.LENGTH_SHORT).show()
                }
            }
